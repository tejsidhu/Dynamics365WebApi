...
namespace service
{
    public class GetContacts : IDisposable
    {
        ...
        private static HttpClient ConnectToCRM(String[] cmdargs)
        {
            ...
            {
                BaseAddress = new Uri(config.ServiceUrl + "api/data/v9.2/"),
                Timeout = new TimeSpan(0, 2, 0)
            };
            httpClient.DefaultRequestHeaders.Add("OData-MaxVersion", "4.0");
            httpClient.DefaultRequestHeaders.Add("OData-Version", "4.0");
            httpClient.DefaultRequestHeaders.Add("x-client-Ver", "5.13.0.0");
            httpClient.DefaultRequestHeaders.Add("x-client-SKU", "MSAL.NET");
            httpClient.DefaultRequestHeaders.Add("x-client-OS", "Microsoft Windows NT 6.2.9200.0");
